...
export default function Bandeja() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-background via-secondary/10 to-primary/5">
      {/* Sidebar - Toolbar */}
      <aside className={`${sidebarOpen ? 'w-80' : 'w-0'} transition-all duration-300 bg-white/95 backdrop-blur-xl border-r border-primary/10 shadow-lg overflow-hidden h-screen fixed top-0 left-0 z-40`}>
      ...
      <div className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ${sidebarOpen ? 'ml-80' : 'ml-0'}`}>
        ...
        <main className="flex-1 p-3 sm:p-4 lg:p-6 pb-0">
